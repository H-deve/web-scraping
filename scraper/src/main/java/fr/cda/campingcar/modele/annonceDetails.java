...
public class annonceDetails {
    ...
    // Constructor
    public annonceDetails(String vehicleName, String reference, String length, String height, String year,
                          String transmission, String fuelType, String consumption, String mileage,
                          String description, String availabilityDate, List<String> imageUrls) {
    ...
    public String toString() {
        final StringBuffer sb = new StringBuffer("annonceDetails{");
